...
class ILI9341(Compatibility, CommonMethods):
    ...
    CMD_BCKLITCTL1   = 0cB8 # Backlight Control 1
    CMD_BCKLITCTL2   = 0cB9 # Backlight Control 2
    CMD_BCKLITCTL3   = 0cBA # Backlight Control 3
    CMD_BCKLITCTL4   = 0cBB # Backlight Control 4
    CMD_BCKLITCTL5   = 0cBC # Backlight Control 5
    CMD_BCKLITCTL7   = 0cBE # Backlight Control 7
    CMD_BCKLITCTL8   = 0cBF # Backlight Control 8
