# CircuitPython
# Basic functionality test on a Raspberry Pi PICO-RP2040 with CircuitPython
#
# Build:
...
import time
from board import GP8, GP9, GP10, GP11, GP15
...
#         rst, rs (dc), port, cs, mosi, sck
tft = ILI9225(GP9, GP8, 0, GP15, GP11, GP10, board=Boards.RP2040) # ID=1
